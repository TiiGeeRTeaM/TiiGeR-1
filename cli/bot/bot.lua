...
chats = {}
plugins = {}
TiiGeRT_sudo = 205549111 -- ایدی سودوی اصلی را قرار دهید
GpsidSudo = -1001137329081
bot_id = 534903064 -- ایدی ربات را قرار دهید
helper_id =  490443711-- ایدی ربات api را قرار دهید
TiiGeRTeaM = 'TiiGeRTeaM' -- یوزرنیم کانال خود را قرار دهید
TiiGeRTeaM = ' arashwm' -- یوزرنیم خود را قرار دهید
TiiGeRTeaMbot = '@v'  -- یوزرنیم پیام رسان خود را قرار دهید
paypinglink = 'Sr' -- لینک payping  خود را قرار دهید
paypingname = 'Arashwm' -- اسم خود را وارد نماید
...
function create_config( )
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {205549111,534903564,97476034}, -- در اینجا آیدی ربات api و cli  و سودو ها را وارد کنید
    admins = {},
    disabled_channels = {},
