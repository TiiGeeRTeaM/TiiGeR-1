...
local function list_all_plugins(only_enabled)
  local tmp = '\n\n[TiiGeRTeaM](Telegram.Me/TiiGeRTeaM)'
  local text = ''
  local nsum = 0
  for k, v in pairs( plugins_names( )) do
    local status = '*|✖️|>*'
...
local settings = data[tostring(GP_id)]["settings"]
 text = '*به تنظیمات پیام های مکرر خوش آمدید* 🤖'
	...
	keyboard.inline_keyboard = {
		{
			{text = '✦ حداکثر پیام های مکرر ♻️', callback_data = 'TiiGeRTeaM'}
		},
		{
...
-- شرط ولکام
 ...
 if(mute_photo=="yes")then mute_photo_text = "فعال✅"elseif(mute_photo=="kick")then mute_photo_text = "حالت اخراج📛"elseif(mute_photo=="no")then mute_photo_text = "غیرفعال❌"elseif(mute_photo=="warn")then mute_photo_text = "حالت اخطار🚷"end
	...
	keyboard.inline_keyboard = {
		{
			{text = "✦ قفل ویرایش ✏️: "..lock_edit_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل لینک 📎: "..lock_link_text.."", callback_data='TiiGeRTeaM'}
		},
		{
		...
		{
			{text = "✦ قفل تگ #️⃣ : "..lock_tag_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل نام کاربری 🆔:"..lock_username_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل فراخوانی ⚠️: "..lock_mention_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل عربی 🔠: "..lock_arabic_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل انگلیسی 🔠: "..lock_english_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل صفحات وب 🌐: "..lock_webpage_text.."", callback_data='TiiGeRTeaM'}, 
		},
		{
		...
		{
			{text = "✦ قفل فونت 💱: "..lock_markdown_text.."", callback_data='TiiGeRTeaM'}, 
		},
		{
		...
		{
			{text = "✦ قفل تصاویر متحرک 🎇: "..mute_gif_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل متن 🔤: "..mute_text_text.."", callback_data='TiiGeRTeaM'}  
		},
		{
		...
		{
			{text = "✦ قفل اینلاین ✨: "..mute_inline_text.."", callback_data='TiiGeRTeaM'}, 
		},
		{
		...
		{
			{text = "✦ قفل بازی 🎮: "..mute_game_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل عکس 🌄: "..mute_photo_text.."", callback_data='TiiGeRTeaM'}  
		},
		{
...
function mutelists(msg, data, GP_id) 
   ...
   if mutes.mute_document then
	...
	keyboard.inline_keyboard = {
		{
		{text = "✦ قفل فیلم 🎥: "..mute_video_text.."", callback_data='TiiGeRTeaM'}
		},
		{
		...
		{
		{text = "✦ قفل فیلم سلفی 🎥: "..mute_video_self_text.."", callback_data='TiiGeRTeaM'}
		},
		{
		...
		{
			{text = "✦ قفل آهنگ 🎵: "..mute_audio_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل ویس 🎙: "..mute_voice_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل استیکر 🔰: "..mute_sticker_text.."", callback_data='TiiGeRTeaM'}
		},
		{
		...
		{
			{text = "✦ قفل مخاطب ☎️: "..mute_contact_text.."", callback_data='TiiGeRTeaM'}
		},
		{
		...
		{
			{text = "✦ قفل نقل قول 🔗: "..mute_forward_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل مکان 📡: "..mute_location_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل فایل 📂: "..mute_document_text.."", callback_data='TiiGeRTeaM'}  
		},
		{
		...
		{
			{text = "✦ قفل کیبورد 🎹: "..mute_keyboard_text.."", callback_data='TiiGeRTeaM'} 
		},
		{
		...
		{
			{text = "✦ قفل سرویس تلگرام 📡", callback_data='TiiGeRTeaM'}, 
			{text = mute_tgservice_text, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "✦ قفل سنجاق 📌", callback_data='TiiGeRTeaM'}, 
			{text = lock_pin_text, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "✦ قفل ربات‌های تبلیغگر🤖", callback_data='TiiGeRTeaM'}, 
			{text = lock_bots_text, callback_data="/lockbots:"..GP_id}
		},
		{
			{text = "✦ قفل ورود ⚡️", callback_data='TiiGeRTeaM'}, 
			{text = lock_join_text, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "✦ قفل پیام مکرر 💥", callback_data='TiiGeRTeaM'}, 
			{text = lock_flood_text, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "✦ قفل هرزنامه ☢️", callback_data='TiiGeRTeaM'}, 
			{text = lock_spam_text, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "✦ خوش‌آمد گویی 🤹‍♂️", callback_data'TiiGeRTeaM'},
...
🆔 : @TiiGeRTeaM]]
    ...
    edit_inline(msg.message_id, text..TiiGeRTeaM, keyboard)
end
end
